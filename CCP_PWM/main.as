...
;!COMRAM              5F      4       8       1        8.4%
;!BITBIGSFRhhh        34      0       0      21        0.0%
;!BITBIGSFRll         34      0       0      25        0.0%
;!BITBIGSFRlh         28      0       0      24        0.0%
;!BITBIGSFRhhl         8      0       0      22        0.0%
;!BITBIGSFRhl          2      0       0      23        0.0%
...
l797:
	movff	(c:_dc),??_main+0+0
	movff	(c:_dc+1),??_main+0+0+1
	bcf	status,0
	rrcf	(??_main+0+1)^00h,c
	rrcf	(??_main+0+0)^00h,c
	bcf	status,0
	rrcf	(??_main+0+1)^00h,c
	rrcf	(??_main+0+0)^00h,c
...
l785:
	...
	line	61
	movff	(c:_dc),??_setup+0+0
	movff	(c:_dc+1),??_setup+0+0+1
	bcf	status,0
