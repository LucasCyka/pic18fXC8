...
__pcstackCOMRAM:
?_init_interrupts:	; 1 bytes @ 0x0
?_isr_routine:	; 1 bytes @ 0x0
??_isr_routine:	; 1 bytes @ 0x0
?_main:	; 2 bytes @ 0x0
	ds   1
??_init_interrupts:	; 1 bytes @ 0x1
??_main:	; 1 bytes @ 0x1
	ds   2
;!
;!Data Sizes:
...
l786:
	bsf	(0+(1/8)+(c:3987))^0f00h,c,(1)&7	;volatile
	line	35
	
l788:
	call	_init_interrupts	;wreg free
	line	39
...
asmopt off
movlw	195
movwf	(??_isr_routine+0+0)^00h,c
	movlw	205
i2u3_47:
decfsz	wreg,f
	bra	i2u3_47
	decfsz	(??_isr_routine+0+0)^00h,c,f
	bra	i2u3_47
	nop
asmopt pop
